...
Arguments:
    ...
    DelayInterval - Supplies the absolute of relative time over which the delay is to occur.
*/
{
    LARGE_INTEGER Interval;
    KPROCESSOR_MODE PreviousMode;

    // Get previous processor mode and probe delay interval address if necessary.
    ...
    return KeDelayExecutionThread(PreviousMode, Alertable, &Interval);// Delay execution for the specified amount of time.
}