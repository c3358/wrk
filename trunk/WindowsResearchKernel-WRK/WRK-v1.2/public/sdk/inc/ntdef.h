...
//  language ID that sublanguage ID can be combined with to form a valid language ID.
...
//  A language ID is a 16 bit value which is the combination of a primary language ID and a secondary language ID.  The bits are
...
//  A locale ID is a 32 bit value which is the combination of a language ID, a sort ID, and a reserved area.  The bits are
//  allocated as follows:
